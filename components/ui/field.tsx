...
function FieldGroup({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn(
                '@container/field-group group/field-group flex flex-col gap-5 [&>[data-slot=field-group]]:gap-4 data-[slot=checkbox-group]:gap-3 w-full',
                className,
            )}
            {...props}
        />
...
const fieldVariants = cva('group/field flex gap-3 w-full data-[invalid=true]:text-destructive', {
    variants: {
        orientation: {
...
function FieldContent({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn('group/field-content flex flex-col flex-1 gap-1.5 leading-snug', className)}
            {...props}
        />
    );
}
