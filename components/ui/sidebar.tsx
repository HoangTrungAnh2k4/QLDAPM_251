...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                'flex items-center px-3 rounded-md outline-hidden ring-sidebar-ring focus-visible:ring-2 h-8 [&>svg]:size-4 font-medium text-sidebar-foreground/70 text-xs transition-[margin,opacity] duration-200 ease-linear shrink-0 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
    'peer/menu-button flex items-center gap-2 data-[active=true]:bg-primary data-[state=open]:hover:bg-primary hover:bg-primary active:bg-primary aria-disabled:opacity-50 disabled:opacity-50 group-data-[collapsible=icon]:p-2! px-3 py-5 group-has-data-[sidebar=menu-action]/menu-item:pr-8 rounded-md outline-hidden ring-sidebar-ring focus-visible:ring-2 w-full [&>svg]:size-4 group-data-[collapsible=icon]:size-8! overflow-hidden data-[active=true]:font-medium font-semibold data-[active=true]:text-white text-sm text-left [&>span:last-child]:truncate transition-[width,height,padding] data-[state=open]:hover:text-sidebar-accent-foreground hover:text-sidebar-accent-foreground active:text-sidebar-accent-foreground cursor-pointer aria-disabled:pointer-events-none disabled:pointer-events-none [&>svg]:shrink-0',
    {
        variants: {
            variant: {
